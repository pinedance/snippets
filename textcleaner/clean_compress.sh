...
echo "* made tmp folders" ; mkdir _rst ; mkdir rst 
...
for file in ./tmp/* 
do 
    ./textcleaner -g -e stretch -f 25 -o 5 -s 1 ${file} ./_rst/${file##*/}
    convert ./_rst/${file##*/} -compress fax ./rst/${file##*/}
    echo -n "."
done
...
rm -rf tmp ; rm -rf _rst ; rm -rf rst
